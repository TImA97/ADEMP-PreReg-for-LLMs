...
\newcommand{\maketitlepage}{%
    \begin{titlepage}
        ...
        Angelike, T, \& Heck, D. W. (2026). Evaluating Large Language Models for Feature Extraction from Verbal Stimuli: A Simulation-Based Workflow. [LINK XXX] \\ 
